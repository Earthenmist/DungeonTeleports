...
-- Shared internal catalog IDs to fallback names; display callers use GetDungeonName.
...
-- Shared internal catalog IDs to teleport spells.
local mapIDtoSpellID = {
    ...
    [506] = 0, -- Siege of Boralus: resolved by GetTeleportSpellID for the player's faction.
    [507] = 0, -- The MOTHERLODE!!: resolved by GetTeleportSpellID for the player's faction.
